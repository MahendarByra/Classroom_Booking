...
<link rel="stylesheet" href="OfficeMemberHome.css">
...
<body>
		...
		<div id = "Rebook" name = "Rebook">
					<h1 style="text-align: center;">Rebook Section</h1>	
					<span>Date  : </span>
					<input type = "date" id = "rebookDate" name = "rebookDate" onkeyup = "validateRebookDate()">&emsp;&emsp;
					<span>From  :</span>
					<input type = "time" id = "rebookFrom" name = "rebookFrom" onkeyup = "validateRebookFromTime()">&emsp;&emsp;	
					<span>To  :</span>
					<input type = "time" id = "rebookTo" name = "rebookTo" onkeyup = "validateRebookToTime()">&emsp;&emsp;	
					<button onclick = "getList()">Submit</button>
					<p class="error" id = "reBookError"></p>
					
					<div id = "reBookMsg">
					
					</div><br>
					<div id = "rebookList" style = "margin: auto; text-align: center; width: 500px;">
	...
	<script src = "OfficeMemberHome.js"></script>
</body>
</html>